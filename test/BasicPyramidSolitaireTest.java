...
/**
 * Test class for cs3500.pyramidSolitaire.model.hw04.BasicPyramidSolitaire: unit tests to ensure
 * that the functions of the game state in the class
 * cs3500.pyramidSolitaire.model.hw04.BasicPyramidSolitaire
 * function correctly covering all the cases and implementing the and hence, implementing and
 * setting up the Pyramid Solitaire Model of the Pyramid Solitaire game based on the rules,
 * specifications and cases of each phase of the game.
 */
...
public class BasicPyramidSolitaireTest {
  ...
  public void initTests() {
    ...
    firstValidModel = new BasicPyramidSolitaire();
    ...
    firstValidModelGameOver = new BasicPyramidSolitaire();
   ...
   * deck in the case of the valid deck being returned when getDeck is called on the model.
   */
  @Test
  public void getDeckTest() {
    ...
    // to 52 while checking the the test for the getDeck function called on the firstValidModel
  ...
  // Represents the game which is shuffled its deck in the starting of the game
  @Test
  public void startGameShuffledDeck() {
    initTests();
  ...
  /**
   * Represents the game which is does not shuffle its deck in the starting of the game.
   */
  @Test
  public void startGameNonShuffledDeck() {
    initTests();
    // Testing a valid deck, valid number of rows, draw cards and the number of cards
  ...
  /**
   * Testing a deck which is either null or invalid.
   */
  @Test(expected = IllegalArgumentException.class)
  public void startGameWithInvalidDeck() {
    initTests();
  ...
  /**
   * Testing a deck which is null and hence throws an IllegalArgumentException.
   */
  @Test(expected = IllegalArgumentException.class)
  public void startGameWithNullDeck() {
    initTests();
    // Represents the invalid deck example used for the exceptions in the game that throw
    // IllegalArgumentExceptions for example when the deck does not have 52 cards, 4 suites or
    // 13 different cards in each
   ...
   */
  @Test(expected = IllegalArgumentException.class)
  public void startGameWithNonPositiveRows() {
    initTests();
   ...
   */
  @Test(expected = IllegalArgumentException.class)
  public void startGameWithNonPositiveRows1() {
    initTests();
   ...
   */
  @Test(expected = IllegalArgumentException.class)
  public void startGameWithNegativeDrawCards() {
    initTests();
   ...
   */
  @Test(expected = IllegalArgumentException.class)
  public void startGameWithNegativeDrawCards1() {
    initTests();
   ...
   * where the number of rows might exceed the maximum limit.
   */
  @Test(expected = IllegalArgumentException.class)
  public void startGameWithExceedingRows() {
    initTests();
  ...
  /**
   * Testing a full pyramid and draw pile cannot be dealt with the number of given cards in deck
   * where the number of draw cards might exceed the maximum limit.
   */
  @Test(expected = IllegalArgumentException.class)
  public void startGameWithExceedingDrawCards() {
    initTests();
  ...
  /**
   * Testing a full pyramid and draw pile cannot be dealt with the number of given cards in deck
   * where the all the values are invalid.
   */
  @Test(expected = IllegalArgumentException.class)
  public void startGameWithAllInvalidValues() {
    initTests();
    sizeOfDeck = -2;
   ...
   */
  @Test
  public void removeTwoCardsSuccess() {
    initTests();
   ...
   * is invalid due to some reasons and hence, throws an IllegalArgumentException.
   */
  ...
  public void removeTwoCardsGameNotStarted() {
    initTests();
    PyramidSolitaireTextualView viewModel = new PyramidSolitaireTextualView(firstValidModel);
    System.out.println(viewModel.toString());
    // Representing starting the game
  ...
  // does not have a combination with the other card to add up to 13
  @Test(expected = IllegalArgumentException.class)
  public void removeTwoCardsInvalidRemove() {
    initTests();
    firstValidModel.startGame(firstValidModel.getDeck(), false, 7, 2);
    PyramidSolitaireTextualView viewModel = new PyramidSolitaireTextualView(firstValidModel);
    System.out.println(viewModel.toString());
  ...
  // a null area, throwing an IllegalArgumentException
  @Test(expected = IllegalArgumentException.class)
  public void removeTwoCardsInvalidRemoveFromNullArea() {
    initTests();
    firstValidModel.startGame(firstValidModel.getDeck(), false, 7, 2);
    PyramidSolitaireTextualView viewModel = new PyramidSolitaireTextualView(firstValidModel);
    System.out.println(viewModel.toString());
  ...
  @Test(expected = IllegalArgumentException.class)
  public void removeTwoCardsNotExposed() {
    initTests();
    // Representing starting the game
    firstValidModel.startGame(firstValidModel.getDeck(), false, 7, 3);
    // Represents the test for the remove function for this gameRemoveCard model
  ...
  // Represents the case of when the cards are exposed but do not add up to 13
  @Test(expected = IllegalArgumentException.class)
  public void removeTwoCardsNotThirteen() {
    initTests();
    // Representing starting the game
    firstValidModel.startGame(firstValidModel.getDeck(), false, 7, 3);
    // Represents the test for the remove function for this gameRemoveCard model
  ...
  @Test(expected = IllegalArgumentException.class)
  public void removeTwoCardsFromNullAreas() {
    initTests();
    // Representing starting the game
    firstValidModel.startGame(firstValidModel.getDeck(), false, 7, 3);
   ...
   * removed is a king and it is exposed.
   */
  @Test
   ...
   * up to thirteen or is null, and hence, gives an IllegalArgumentException.
   */

  // Represents when the card is not exposed
  @Test(expected = IllegalArgumentException.class)
  public void removeSingleCardInvalidRemoveNotExposed() {
    initTests();
    // Representing starting the game
    firstValidModel.startGame(firstValidModel.getDeck(), false, 7, 3);
    // Represents the test for the remove function for this gameRemoveCard model
  ...
  @Test(expected = IllegalArgumentException.class)
  public void removeSingleCardInvalidRemoveNotKing() {
    initTests();
    // Representing starting the game
    firstValidModel.startGame(firstValidModel.getDeck(), false, 7, 3);
    // Represents the test for the remove function for this gameRemoveCard model
  ...
  // null
  @Test(expected = IllegalArgumentException.class)
  public void removeSingleCardInvalidRemove() {
    initTests();
    // Representing starting the game
    firstValidModel.startGame(firstValidModel.getDeck(), false, 7, 3);
    // Represents the test for the remove function for this gameRemoveCard model
  ...
  // has been removed
  @Test(expected = IllegalArgumentException.class)
  public void removeSingleCardNullAttempt() {
    initTests();
    // Representing starting the game
    firstValidModel.startGame(firstValidModel.getDeck(), false, 7, 3);
  ...
  // when the game has not started leading to throw an IllegalStateException
  @Test(expected = IllegalStateException.class)
  public void removeUsingDrawTestGameNotStarted() {
    initTests();
    // Represents the test for the remove function for this gameRemoveCard model
  ...
  // or the draw pile card does not add up with
  @Test(expected = IllegalArgumentException.class)
  public void removeUsingDrawTestCardNotExposed() {
    initTests();
  ...
  // and the card from the draw pile do not add up to be 13
  @Test(expected = IllegalArgumentException.class)
  public void removeUsingDrawTestCardsNotThirteen() {
    initTests();
  ...
  // both of the cards being attempted to be removed is from a null area
  @Test(expected = IllegalArgumentException.class)
  public void removeUsingDrawTestCardsFromNullAreas() {
    initTests();
  ...
  // invalid
  @Test(expected = IllegalArgumentException.class)
  public void removeUsingDrawTestCardsInvalidIndex() {
    initTests();
  ...
  // invalid
  @Test(expected = IllegalArgumentException.class)
  public void removeUsingDrawTestCardsInvalidIndex1() {
    initTests();
  ...
  // invalid
  @Test(expected = IllegalArgumentException.class)
  public void removeUsingDrawTestCardsInvalidIndex2() {
    initTests();
    ...
    // Representing the removal of the cards first
    firstValidModel.removeUsingDraw(0, 9, 10);
  }

  // Represents the test when the remove is attempted and it is invalid because the index is
  // invalid
  @Test(expected = IllegalArgumentException.class)
  public void removeUsingDrawTestCardsInvalidIndex3() {
    initTests();
  ...
  @Test(expected = IllegalArgumentException.class)
  public void testComplexGameState() {
    initTests();
  ...
  // both of the cards being attempted to be removed is from a null area
  @Test(expected = IllegalArgumentException.class)
  public void removeUsingDrawTestCardsFromNullAreasOtherCard() {
    initTests();
  ...
  // Represents the test of when the cards cannot be removed from a null area
  @Test(expected = IllegalArgumentException.class)
  public void removeUsingDrawTestCardsFromNullAreas1() {
    initTests();
  ...
  /**
   * Represents the function discardDraw that discards an individual card from the draw pile.
   */
  ...
  // valid because of being negative
  @Test(expected = IllegalArgumentException.class)
  public void discardDrawIndexNegativeInvalid() {
    initTests();
  ...
  // Represents the case of when the individual card cannot be discarded since the draw index is not
  // valid because of exceeding the limit of cards in the stock pile (That is 23)
  @Test(expected = IllegalArgumentException.class)
  public void discardDrawIndexExceedsInvalid() {
    initTests();
    ...
    // Represents draw index value being negative and hence, throwing a new IllegalArgumentException
    firstValidModel.discardDraw(25);
  }
  ...
  // the draw card with
  @Test(expected = IllegalArgumentException.class)
  public void discardDrawNothingToReplaceWhenGameOver() {
    initTests();
   ...
   * the pyramid, or -1 if the game has not started yet.
   */

  // Represents the test for when the game has not started and the function should return -1
  @Test
  public void getNumRowsValidGameNotStarted() {
    initTests();
    // Represents a model
    PyramidSolitaireModel<Card> gameGetNumRowsFrom = new BasicPyramidSolitaire();
   ...
   */
  @Test
  public void getNumRowsValidGameStarted() {
    initTests();
    // Represents a model
    PyramidSolitaireModel<Card> gameGetNumRowsFrom = new BasicPyramidSolitaire();
   ...
   */
  @Test(expected = IllegalArgumentException.class)
  public void getNumRowsValidGameStarted1() {
    initTests();
    // Represents a model
    PyramidSolitaireModel<Card> gameGetNumRowsFrom = new BasicPyramidSolitaire();
    // starts the game for the model
  ...
  /**
   * Represents the test for when the game has negative number of rows.
   */
  @Test(expected = IllegalArgumentException.class)
  public void getNumRowsInvalidGameStarted() {
    initTests();
    // Represents a model
    PyramidSolitaireModel<Card> gameGetNumRowsFrom = new BasicPyramidSolitaire();
    // starts the game for the model
   ...
   */
  @Test(expected = IllegalArgumentException.class)
  public void getNumRowsInvalidGameRowsExceeded() {
    initTests();
    // Represents a model
    PyramidSolitaireModel<Card> gameGetNumRowsFrom = new BasicPyramidSolitaire();
    // starts the game for the model
  ...
  /**
   * Represents the tests for the function getNumDraw when the game has not been started.
   */
  @Test
  ...
  /**
   * Represents the tests for the function getNumDraw when the game has been started.
   */
  @Test
  public void getNumDrawGameStarted() {
    initTests();
    // Represents a model
    PyramidSolitaireModel<Card> gameGetDrawsFrom = new BasicPyramidSolitaire();
    // starts the game for the model
   ...
   * of draw cards is negative or too much.
   */
  @Test(expected = IllegalArgumentException.class)
  public void getNumDrawGameStartedNegative() {
    initTests();
    // Represents a model
    PyramidSolitaireModel<Card> gameGetDrawsFrom = new BasicPyramidSolitaire();
    // starts the game for the model
   ...
   * of the number of draw cards is valid.
   */
  @Test
  public void getNumDrawGameStarted1() {
    initTests();
    // Represents a model
    PyramidSolitaireModel<Card> gameGetDrawsFrom = new BasicPyramidSolitaire();
    // starts the game for the model
  ...
  @Test
  public void getRowWidthValidCases() {
    initTests();
    // Represents a model
    firstValidModel.startGame(firstValidModel.getDeck(), false, 7, 2);
    ...
    // Represents the test taking into consideration the firstValidModel pyramid solitaire game
    assertEquals(7, firstValidModel.getRowWidth(6));
  ...
  @Test(expected = IllegalStateException.class)
  public void getRowWidthGameNotStarted() {
    initTests();
   ...
   * invalid amount of rows leading to throwing IllegalArgumentExceptions.
   */

  @Test(expected = IllegalArgumentException.class)
  public void getRowWidthGameInvalidRowNegative() {
    initTests();
    // Represents a model
    firstValidModel.startGame(firstValidModel.getDeck(), false, 7, 2);
   ...
   * on the amount of removes left from the pyramid and the discards from the draw pile.
   */
  @Test
  ...
  public void testToString() {
    ...
    PyramidSolitaireModel<Card> toStringGameOver = new BasicPyramidSolitaire();
